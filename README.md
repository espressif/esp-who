...
> Please use the latest ESP-IDF on the [release/v4.4](https://github.com/espressif/esp-idf/tree/release/v4.4) branch. If you are using ESP-IDF [release/v5.0](https://github.com/espressif/esp-idf/tree/release/v5.0) branch, please switch the ESP-WHO branch to the master.
