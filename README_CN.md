...
> 请使用 ESP-IDF 在 [release/v4.4](https://github.com/espressif/esp-idf/tree/release/v4.4) 分支上的最新版本。如果你使用的是 ESP-IDF [release/v5.0](https://github.com/espressif/esp-idf/tree/release/v5.0)，请将 ESP-WHO 的分支切换到 master
