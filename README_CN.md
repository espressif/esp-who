...
该分支适用于 ESP-IDF [release/v5.0](https://github.com/espressif/esp-idf/tree/release/v5.0)。假如你使用的是 ESP-IDF [release/v4.4](https://github.com/espressif/esp-idf/tree/release/v4.4)，请将 ESP-WHO 的分支切换到 master。
