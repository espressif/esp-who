...
void c_impl_min_n_1(feature_t *output_ptr,
...
template <typename feature_t>
void c_impl_min_1_n(feature_t *output_ptr,
                    feature_t *input0_ptr,
                    feature_t *input1_ptr,
                    elemwiseArgsType<feature_t> *args)
{
...
template <typename feature_t>
void c_impl_min_n_n(feature_t *output_ptr,
                    feature_t *input0_ptr,
                    feature_t *input1_ptr,
                    elemwiseArgsType<feature_t> *args)
{
...
void elemwise_min(elemwiseArgsType<int8_t> *args)
{
    ...
    std::function<void(int8_t *, int8_t *, int8_t *, elemwiseArgsType<int8_t> *)> elemwise_func =
        c_impl_min_n_n<int8_t>; // default impl
    ...
    if (args->output_d0 >= ilen) {
        ...
        if (args->input0_d0 % ilen == 0 && args->input1_d0 % ilen == 0) {
            ...
            if (args->input0_d0 % ilen == 0) {
                elemwise_func = dl_esp32p4_s8_min4d_bchw_w1_16_w2_1_simdmin;
            } else {
                elemwise_func = dl_esp32p4_s8_min4d_bchw_w1_16_w2_1_simdmin_unaligned;
            }
        } else if (args->input0_d0 == 1) {
            if (args->input1_d0 % ilen == 0) {
                elemwise_func = dl_esp32p4_s8_min4d_bchw_w1_1_w2_16_simdmin;
            } else {
                elemwise_func = dl_esp32p4_s8_min4d_bchw_w1_1_w2_16_simdmin_unaligned;
            }
        } else {
...
//         } else if (args->input1_d0 == 1) {
//             if (args->input0_d0 % ilen == 0) {
//                 elemwise_func = dl_esp32s3_s8_min4d_bchw_w1_16_w2_1_simdmin;
//             } else {
//                 elemwise_func = dl_esp32s3_s8_min4d_bchw_w1_16_w2_1_simdmin_unaligned;
//             }
//         } else if (args->input0_d0 == 1) {
//             if (args->input1_d0 % ilen == 0) {
//                 elemwise_func = dl_esp32s3_s8_min4d_bchw_w1_1_w2_16_simdmin;
//             } else {
//                 elemwise_func = dl_esp32s3_s8_min4d_bchw_w1_1_w2_16_simdmin_unaligned;
//             }
//         } else {
//             elemwise_func = dl_esp32s3_s8_min4d_bchw_w1_16_w2_16_simdmin_unaligned;
//         }
#else
        if (args->input1_d0 == 1) {
            elemwise_func = c_impl_min_n_1<int8_t>;
        } else if (args->input0_d0 == 1) {
            elemwise_func = c_impl_min_1_n<int8_t>;
        }
#endif
    } else {
        if (args->input1_d0 == 1) {
...
void elemwise_min(elemwiseArgsType<int16_t> *args)
{
    ...
    if (args->output_d0 >= ilen) {
        ...
        if (args->input0_d0 % ilen == 0 && args->input1_d0 % ilen == 0) {
            ...
            if (args->input0_d0 % ilen == 0) {
                elemwise_func = dl_esp32p4_s16_min4d_bchw_w1_8_w2_1_simdmin;
            } else {
                elemwise_func = dl_esp32p4_s16_min4d_bchw_w1_8_w2_1_simdmin_unaligned;
            }
        } else if (args->input0_d0 == 1) {
            if (args->input1_d0 % ilen == 0) {
                elemwise_func = dl_esp32p4_s16_min4d_bchw_w1_1_w2_8_simdmin;
            } else {
                elemwise_func = dl_esp32p4_s16_min4d_bchw_w1_1_w2_8_simdmin_unaligned;
            }
        } else {
...
//         } else if (args->input1_d0 == 1) {
//             if (args->input0_d0 % ilen == 0) {
//                 elemwise_func = dl_esp32s3_s16_min4d_bchw_w1_8_w2_1_simdmin;
//             } else {
//                 elemwise_func = dl_esp32s3_s16_min4d_bchw_w1_8_w2_1_simdmin_unaligned;
//             }
//         } else if (args->input0_d0 == 1) {
//             if (args->input1_d0 % ilen == 0) {
//                 elemwise_func = dl_esp32s3_s16_min4d_bchw_w1_1_w2_8_simdmin;
//             } else {
//                 elemwise_func = dl_esp32s3_s16_min4d_bchw_w1_1_w2_8_simdmin_unaligned;
//             }
//         } else {
//             elemwise_func = dl_esp32s3_s16_min4d_bchw_w1_8_w2_8_simdmin_unaligned;
//         }
#else
        if (args->input1_d0 == 1) {
            elemwise_func = c_impl_min_n_1<int16_t>;
        } else if (args->input0_d0 == 1) {
            elemwise_func = c_impl_min_1_n<int16_t>;
        }
#endif
    } else {
        if (args->input1_d0 == 1) {
