...
// inline void equal4d_bchw_w1_16_w2_16(feature_t *output_ptr,
...
//                 dl_esp32p4_s8_equal4d_bchw_w1_16_w2_16_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                 dl_esp32s3_s8_equal4d_bchw_w1_16_w2_16_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #endif
...
// template <typename feature_t, typename buffer_t>
// inline void equal4d_bchw_w1_16_w2_1(feature_t *output_ptr,
//                                     feature_t *input0_ptr,
//                                     feature_t *input1_ptr,
//                                     const arithArgsType<feature_t> &args)
// {
...
//             for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                 dl_esp32p4_s8_equal4d_bchw_w1_16_w2_1_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                 dl_esp32s3_s8_equal4d_bchw_w1_16_w2_1_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #endif
//                 output_ptr_base += args.output_w;
...
// template <typename feature_t, typename buffer_t>
// inline void equal4d_bchw_w1_1_w2_16(feature_t *output_ptr,
//                                     feature_t *input0_ptr,
//                                     feature_t *input1_ptr,
//                                     const arithArgsType<feature_t> &args)
// {
...
//             for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                 dl_esp32p4_s8_equal4d_bchw_w1_1_w2_16_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                 dl_esp32s3_s8_equal4d_bchw_w1_1_w2_16_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #endif
//                 output_ptr_base += args.output_w;
//                 input0_ptr_base += input0_w;
...
// template <typename feature_t, typename buffer_t>
// inline void equal4d_bchw_w1_8_w2_8(feature_t *output_ptr,
//                                    feature_t *input0_ptr,
//                                    feature_t *input1_ptr,
//                                    const arithArgsType<feature_t> &args)
// {
...
//             for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                 dl_esp32p4_s16_equal4d_bchw_w1_8_w2_8_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                 dl_esp32s3_s16_equal4d_bchw_w1_8_w2_8_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #endif
//                 output_ptr_base += args.output_w;
//                 input0_ptr_base += input0_w;
...
// template <typename feature_t, typename buffer_t>
// inline void equal4d_bchw_w1_8_w2_1(feature_t *output_ptr,
//                                    feature_t *input0_ptr,
//                                    feature_t *input1_ptr,
//                                    const arithArgsType<feature_t> &args)
// {
...
//             for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                 dl_esp32p4_s16_equal4d_bchw_w1_8_w2_1_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                 dl_esp32s3_s16_equal4d_bchw_w1_8_w2_1_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #endif
//                 output_ptr_base += args.output_w;
//                 input0_ptr_base += input0_w;
...
// template <typename feature_t, typename buffer_t>
// inline void equal4d_bchw_w1_1_w2_8(feature_t *output_ptr,
//                                    feature_t *input0_ptr,
//                                    feature_t *input1_ptr,
//                                    const arithArgsType<feature_t> &args)
// {
...
//             for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                 dl_esp32p4_s16_equal4d_bchw_w1_1_w2_8_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                 dl_esp32s3_s16_equal4d_bchw_w1_1_w2_8_simdequal(
//                     output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
// #endif
//                 output_ptr_base += args.output_w;
//                 input0_ptr_base += input0_w;
...
// template <typename feature_t, typename buffer_t>
// inline void equal4d_bchw_rescale(feature_t *output_ptr,
//                                  feature_t *input0_ptr,
//                                  feature_t *input1_ptr,
//                                  const arithArgsType<feature_t> &args)
// {
...
//                     *output_ptr_base = DL_EQUAL(*input0_row_ptr, *input1_row_ptr);
...
// // int8
// template <typename feature_t, typename buffer_t>
// inline void equal4d_bchw_rescale_int8(feature_t *output_ptr,
//                                       feature_t *input0_ptr,
//                                       feature_t *input1_ptr,
//                                       const arithArgsType<feature_t> &args)
// {
...
//                     for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                         dl_esp32p4_s8_equal4d_bchw_w1_16_w2_16_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                         dl_esp32s3_s8_equal4d_bchw_w1_16_w2_16_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #endif
//                         output_ptr_base += args.output_w;
//                         input0_ptr_base += input0_w;
...
//                     for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                         dl_esp32p4_s8_equal4d_bchw_w1_1_w2_16_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                         dl_esp32s3_s8_equal4d_bchw_w1_1_w2_16_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #endif
//                         output_ptr_base += args.output_w;
//                         input0_ptr_base += input0_w;
...
//                     for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                         dl_esp32p4_s8_equal4d_bchw_w1_16_w2_1_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                         dl_esp32s3_s8_equal4d_bchw_w1_16_w2_1_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #endif
//                         output_ptr_base += args.output_w;
//                         input0_ptr_base += input0_w;
...
// // int8
// template <typename feature_t, typename buffer_t>
// inline void equal4d_bchw_rescale_int16(feature_t *output_ptr,
//                                        feature_t *input0_ptr,
//                                        feature_t *input1_ptr,
//                                        const arithArgsType<feature_t> &args)
// {
...
//                     for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                         dl_esp32p4_s16_equal4d_bchw_w1_8_w2_8_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                         dl_esp32s3_s16_equal4d_bchw_w1_8_w2_8_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #endif
//                         output_ptr_base += args.output_w;
//                         input0_ptr_base += input0_w;
...
//                     for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                         dl_esp32p4_s16_equal4d_bchw_w1_1_w2_8_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                         dl_esp32s3_s16_equal4d_bchw_w1_1_w2_8_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #endif
//                         // for (int lLoop = 0; lLoop < args.output_w; lLoop++) {
//                         //     printf("output_ptr_base = %d, input0_ptr_base = %d, input1_ptr_base = %d\n",
//                         //     output_ptr_base[lLoop], input0_ptr_base[lLoop * args.input0_w_same],
...
//                     for (int kLoop = 0; kLoop < args.output_h; kLoop++) {
// #ifdef CONFIG_IDF_TARGET_ESP32P4
//                         dl_esp32p4_s16_equal4d_bchw_w1_8_w2_1_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #elif defined CONFIG_IDF_TARGET_ESP32S3
//                         dl_esp32s3_s16_equal4d_bchw_w1_8_w2_1_simdequal_unaligned(
//                             output_ptr_base, input0_ptr_base, input1_ptr_base, args_temp);
// #endif
//                         // for (int lLoop = 0; lLoop < args.output_w; lLoop++) {
//                         //     printf("output_ptr_base = %d, input0_ptr_base = %d, input1_ptr_base = %d\n",
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// // specialize equal4d<int16_t>
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// inline void load_equal4d_11c_s16(arith_i_impl_func_s16_t &i_impl_func,
...
//         c_impl_func = equal4d_bchw_w1_8_w2_8<int16_t, int32_t>;
//     } else if (args.input0_w % 8 == 0 && args.input1_w == 1) {
//         c_impl_func = equal4d_bchw_w1_8_w2_1<int16_t, int32_t>;
//     } else if (args.input0_w == 1 && args.input1_w % 8 == 0) {
//         c_impl_func = equal4d_bchw_w1_1_w2_8<int16_t, int32_t>;
//     } else {
//         c_impl_func = equal4d_bchw_rescale_int16<int16_t, int32_t>;
//     }
// #else
//     c_impl_func = equal4d_bchw_rescale_int16<int16_t, int32_t>;
// #endif
...
// template <>
// void equal4d<int16_t>(void *const args_ptr)
// {
...
//     load_equal4d_11c_s16(i_impl_func, c_impl_func, n_wise_tail, args);

//     arith_operation_shell_<int16_t>(args, i_impl_func, c_impl_func, n_wise_tail);
// }

// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// // specialize equal4d<int8_t>
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// inline void load_equal4d_11c_s8(arith_i_impl_func_s8_t &i_impl_func,
...
//         c_impl_func = equal4d_bchw_w1_16_w2_16<int8_t, int16_t>;
//     } else if (args.input0_w % 16 == 0 && args.input1_w == 1) {
//         c_impl_func = equal4d_bchw_w1_16_w2_1<int8_t, int16_t>;
//     } else if (args.input0_w == 1 && args.input1_w % 16 == 0) {
//         c_impl_func = equal4d_bchw_w1_1_w2_16<int8_t, int16_t>;
//     } else {
//         c_impl_func = equal4d_bchw_rescale_int8<int8_t, int16_t>;
//     }
// #else
//     c_impl_func = equal4d_bchw_rescale_int8<int8_t, int16_t>;
// #endif
...
// template <>
// void equal4d<int8_t>(void *const args_ptr)
// {
...
//     dl_esp32p4_cfg_round(ROUND_MODE_HALF_EVEN);
// #endif
//     load_equal4d_11c_s8(i_impl_func, c_impl_func, n_wise_tail, args);
