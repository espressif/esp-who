...
inline void min2d_11c(feature_t *output_ptr,
                      ...
                      const arithArgsType<feature_t> &args)
{
    ...
    {
        output_ptr[output_c] = DL_MIN(input0_ptr[output_c], input1_ptr[output_c]);
    }
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// specialize min2d<int16_t>
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

inline void load_min2d_11c_s16(arith_i_impl_func_s16_t &i_impl_func,
                               ...
                               const arithArgsType<int16_t> &args)
{
    ...
    if (args.input0_x_offset % 8 == 0 && args.input1_x_offset % 8 == 0 && args.output_x_offset % 8 == 0 &&
        ...
        i_impl_func = dl_tie728_s16_min2d_11c;
    } else {
        i_impl_func = dl_tie728_s16_unaligned_min2d_11c;
    }
...
template <>
void min2d<int16_t>(void *const args_ptr)
{
    ...
    load_min2d_11c_s16(i_impl_func, c_impl_func, n_wise_tail, args);

    arith_operation_shell<int16_t>(args, i_impl_func, c_impl_func, n_wise_tail);
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// specialize min2d<int8_t>
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

inline void load_min2d_11c_s8(arith_i_impl_func_s8_t &i_impl_func,
                              ...
                              const arithArgsType<int8_t> &args)
{
    ...
    if (args.input0_x_offset % 16 == 0 && args.input1_x_offset % 16 == 0 && args.output_x_offset % 16 == 0 &&
        !((unsigned)&args.input0_element[0] & 15) && !((unsigned)&args.input1_element[0] & 15) &&
        !((unsigned)&args.output_element[0] & 15)) {
        i_impl_func = dl_tie728_s8_min2d_11c;
    } else {
        i_impl_func = dl_tie728_s8_unaligned_min2d_11c;
    }
#else
...
template <>
void min2d<int8_t>(void *const args_ptr)
{
    ...
    load_min2d_11c_s8(i_impl_func, c_impl_func, n_wise_tail, args);
