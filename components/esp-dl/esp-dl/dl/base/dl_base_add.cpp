...
void c_impl_add_n_1(feature_t *output_ptr,
...
template <typename feature_t>
void c_impl_add_1_n(feature_t *output_ptr,
                    feature_t *input0_ptr,
                    feature_t *input1_ptr,
                    elemwiseArgsType<feature_t> *args)
{
    ...
    for (int i = 0; i < length; i++) {
        tool::truncate<int32_t>(output_ptr[i], input1_ptr[i] + temp);
    }
}

// input0_ptr:vector, input1_ptr:vector
template <typename feature_t>
void c_impl_add_n_n(feature_t *output_ptr,
                    feature_t *input0_ptr,
                    feature_t *input1_ptr,
                    elemwiseArgsType<feature_t> *args)
{
