...
static void task_event_handler(void *arg)
{
    ...
    while (true)
    {
        ...
        if ((_gEventReceive >= TASK_IDLE) && (_gEventReceive <= AI_TASK_NUM) && (_gEventReceive != gTask))
        {
                            ...
                            const bool camera_fb_return)
{
    ...
    xTaskCreatePinnedToCore(task_idle_handler, "task_idle", 2 * 1024, NULL, 5, NULL, 1);
