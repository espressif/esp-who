...
extern "C" void app_main()
{
    ...
    if (testmode_flag)
    {
        ESP_LOGI(board_version, "--------------- Enter Test Mode ---------------\n");
    ...
    else
    {
        ...
        // ets_printf("\n");
        // ESP_LOGI(board_version, "Firmware CN V0.1.3");
        ...
        print_memory(board_version, 3000);
    }
