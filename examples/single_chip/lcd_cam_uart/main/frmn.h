...
#include "dl_lib_matrix3dq.h"
     ...
     */
    dl_matrix3dq_t *frmn_q(dl_matrix3dq_t *in, int mode);
     ...
     * @return      Face ID feature vector, size is 512
     */
    dl_matrix3dq_t *frmn2p_q(dl_matrix3dq_t *in, int mode);


    dl_matrix3dq_t *mfn56_42m_q(dl_matrix3dq_t *in, int mode);

    dl_matrix3dq_t *mfn56_42m_relu_128_q(dl_matrix3dq_t *in, int mode);

    dl_matrix3dq_t *mfn56_42m_relu_512_q(dl_matrix3dq_t *in, int mode);

    dl_matrix3dq_t *mfn56_72m_q(dl_matrix3dq_t *in, int mode);

    dl_matrix3dq_t *mfn56_112m_q(dl_matrix3dq_t *in, int mode);

    dl_matrix3dq_t *mfn56_156m_q(dl_matrix3dq_t *in, int mode);
