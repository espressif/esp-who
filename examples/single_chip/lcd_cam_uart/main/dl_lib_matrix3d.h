...
#define DL_C_IMPL 0         /*!< ANSI C */
#define DL_XTENSA_IMPL 1    /*!< Handwrite xtensa instruction */
#define DL_TIE_IMPL 2       /*!< Xtensa TIE instruction */
#if CONFIG_XTENSA_IMPL
#define DL_USER_IMPL    DL_XTENSA_IMPL
#elif CONFIG_TIE_IMPL
#define DL_USER_IMPL    DL_TIE_IMPL
#else
#define DL_USER_IMPL    DL_C_IMPL
#endif
...
/**
 * @brief if(out == NULL) the result will be updated in 'in', else in 'out'
 * 
 * @param out 
 * @param in 
 */
void dl_matrix3d_exp(dl_matrix3d_t *out, dl_matrix3d_t *in);

/**
 * @brief Do sigmoid operation on input matrix.
 * if (out == NULL) the result will be update in 'in', else in 'out'
 * 
 * @param m 
 */
void dl_matrix3d_sigmoid(dl_matrix3d_t *out, dl_matrix3d_t *in);
