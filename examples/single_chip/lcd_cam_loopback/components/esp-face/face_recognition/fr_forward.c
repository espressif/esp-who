...
dl_matrix3d_t *get_face_id(dl_matrix3du_t *aligned_face)
{
    ...
    #if CONFIG_FRMN
        dl_matrix3dq_t *face_id_q = frmn_q(mobileface_in, DL_USER_IMPL);
    #elif CONFIG_MFN56_1X
        dl_matrix3dq_t *face_id_q = mfn56_42m_q(mobileface_in, DL_USER_IMPL);
    #elif CONFIG_MFN56_2X
        dl_matrix3dq_t *face_id_q = mfn56_72m_q(mobileface_in, DL_USER_IMPL);
    #elif CONFIG_MFN56_3X
        dl_matrix3dq_t *face_id_q = mfn56_112m_q(mobileface_in, DL_USER_IMPL);
    #elif CONFIG_MFN56_4X
        dl_matrix3dq_t *face_id_q = mfn56_156m_q(mobileface_in, DL_USER_IMPL);
    #endif
