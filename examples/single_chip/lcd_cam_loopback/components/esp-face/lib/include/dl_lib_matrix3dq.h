...
static inline bool dl_matrix3dq_tie_verify(dl_matrix3dq_t *f, dl_conv_mode mode)
{
    if (mode == DL_TIE_IMPL)
    {
        if (f->h == 1 && f->w == 1)
...
static inline bool dl_matrix3dq_xtensa_verify(dl_matrix3dq_t *f, dl_conv_mode mode)
{
